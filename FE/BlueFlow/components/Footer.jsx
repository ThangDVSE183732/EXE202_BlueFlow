...
const NavLink = ({ link, label }) => {
  return (
    <li>
      <a
        href={link}
        className="inline-block text-sm text-gray-400 leading-loose text-body-color hover:text-primary dark:text-dark-6"
      >
        {label}
      </a>
    </li>
          ...
          <div className="-mx-2 flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12 mr-15">
              <div className="mb-10 w-full">
                <a href="/#" className="mb-4 inline-block max-w-[180px] h-auto">
                  <img
                    src="/imgs/logo.png"
                    alt="logo"
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12 ml-10">
              <div className="mb-10 w-full">
                <h4 className="mb-4 text-lg font-bold text-dark dark:text-white">
                  Follow Us On
                </h4>
                <div className="mb-6 flex items-center ml-9">
                  <a
