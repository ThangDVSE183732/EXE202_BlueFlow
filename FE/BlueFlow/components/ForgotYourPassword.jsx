  ...
  return (
    <>
      ...
      <div className="text-left w-full max-w-md px-8 pt-8 pl-12 text-black">
        ...
        <p className="text-left text-sm text-gray-400 mb-10 ml-14">
        ...
        <div className="flex items-center pt-4 space-x-1 ml-14 w-full">
          <div className="flex-1 h-px sm:w-16 bg-gray-300"></div>
          <p className="px-3 text-sm text-gray-600">Login with social accounts</p>
          <div className="flex-1 h-px sm:w-16 bg-gray-300"></div>
        </div>

        <div className="flex justify-center space-x-4 ml-14 w-full">
