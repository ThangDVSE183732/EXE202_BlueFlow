...
namespace EventLink_Repositories.Migrations
{
    ...
    [Migration("20251022120147_AddCompanyLogoToOrganizerProfile")]
    partial class AddCompanyLogoToOrganizerProfile
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SponsorProfile", b =>
                {
                    b.HasBaseType("UserProfile");
                    ...
                    b.Property<string>("SponsorshipFocus")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SupplierProfile", b =>
                {
                    b.HasBaseType("UserProfile");
            ...
            modelBuilder.Entity("OrganizerProfile", b =>
                {
                    b.HasOne("UserProfile", null)
                        .WithOne()
                        .HasForeignKey("OrganizerProfile", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("SponsorProfile", b =>
                {
                    b.HasOne("UserProfile", null)
                        .WithOne()
                        .HasForeignKey("SponsorProfile", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("SupplierProfile", b =>
                {
                    b.HasOne("UserProfile", null)
                        .WithOne()
                        .HasForeignKey("SupplierProfile", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
